-- Signal Platform Database Schema
...
CREATE INDEX IF NOT EXISTS idx_themes_mentions ON themes(mentions DESC);
...
CREATE TABLE IF NOT EXISTS alerts (
    ...
    feedback_ids TEXT DEFAULT '[]', -- JSON array
    created_at TEXT DEFAULT (datetime('now'))
);
...
CREATE INDEX IF NOT EXISTS idx_feature_requests_product ON feature_requests(product);

-- ============================================
-- Trigger for updated_at
-- ============================================
-- Note: D1 doesn't support triggers yet, so updated_at must be set manually in code
